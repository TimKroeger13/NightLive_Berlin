...
def AddToDB():
    try:
        ...
        postgreSQL_select_Query = "CREATE TABLE userdata (id SERIAL UNIQUE, lat double precision, log double precision, date timestamp without time zone, specific varchar(255));"
